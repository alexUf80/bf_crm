    ...
    private static function sendIssuedContracts($contracts)
    {
        ...
        foreach ($contracts as $contract) {
            ...
            foreach ($operations as $operation) {
                ...
                if (in_array($transaction->id, [211976, 206587, 219692, 219685, 225954, 230708, 242605, 244169, 247731, 245536, 250876, 257126, 266059, 266998, 270638, 272493, 287999, 288317, 291524, 296531, 300208, 301560, 307185, 307836, 309244]))
                    continue;
