...
//            'chief_exactor' => 'Руководитель взыскания',
    ...
    public function get_permissions($role)
    {
        ...
        $list_permissions = array(
            'managers' => array('developer', 'admin', 'chief_collector', 'team_collector', 'chief_exactor', 'chief_sudblock', 'city_manager'), // просмотр менеджеров
            ...
            'orders' => array('developer', 'admin', 'user', 'contact_center', 'quality_control', 'collector', 'chief_collector', 'team_collector'),
            'clients' => array('developer', 'admin', 'user', 'contact_center', 'cs_pc'),
            ...
            'penalty_statistics' => array('developer', 'admin', 'user'),
            ...
            'repay_button' => array('developer', 'admin', 'user'),
            'looker_link' => array('developer', 'admin', 'exactor', 'collector', 'user', 'chief_collector', 'team_collector', 'chief_exactor', 'chief_sudblock'),
            ...
            'penalties' => array('developer', 'admin', 'quality_control', 'user', 'cs_pc'),
