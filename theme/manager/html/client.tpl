                                                ...
                                                <div class="row view-block m-0 {if $contacts_error}hide{/if}">
                                                    <table class="table table-hover mb-0">
                                                        <tr>
                                                            ...
                                                            <td>{$client->contact_person_relation}</td>
                                                            <td class="text-right">{$client->contact_person_phone}</td>
                                                            <td>
                                                                <button class="js-mango-call mango-call"
                                                                        data-phone="{$client->contact_person_phone}"
                                                        ...
                                                        <tr>
                                                            <td>{$client->contact_person2_name}</td>
                                                            <td>{$client->contact_person2_relation}</td>
                                                            <td class="text-right">{$client->contact_person2_phone}</td>
                                                            <td>
                                                                <button class="js-mango-call mango-call"
                                                                        data-phone="{$client->contact_person2_phone}"
                                                                        title="Выполнить звонок">
                                                                    <i class="fas fa-mobile-alt"></i>
                                                                </button>
                                                            </td>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group {if in_array('empty_contact_person_name', (array)$contacts_error)}has-danger{/if}">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{$client->contact_person_name}" placeholder=""
                                                                   required="true"/>
                                                            {if in_array('empty_contact_person_name', (array)$contacts_error)}
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group {if in_array('empty_contact_person2_name', (array)$contacts_error)}has-danger{/if}">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{$client->contact_person2_name}"
                                                                   placeholder="" required="true"/>
                                                            {if in_array('empty_contact_person2_name', (array)$contacts_error)}
                                                                <small class="form-control-feedback">Укажите ФИО
                                                                    контакного лица!
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group {if in_array('empty_contact_person2_phone', (array)$contacts_error)}has-danger{/if}">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{$client->contact_person2_phone}"
                                                                   placeholder=""/>
                                                            {if in_array('empty_contact_person2_phone', (array)$contacts_error)}
                                                                <small class="form-control-feedback">Укажите тел.
                                                                    контакного лица!
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table table-hover mb-0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    {if $client->Regindex}{$client->Regindex}, {/if}
                                                                    {$client->Regregion} {$client->Regregion_shorttype},
                                                                    {if $client->Regcity}{$client->Regcity} {$client->Regcity_shorttype},{/if}
                                                                    {if $client->Regdistrict}{$client->Regdistrict} {$client->Regdistrict_shorttype},{/if}
                                                                    {if $client->Reglocality}{$client->Reglocality} {$client->Reglocality_shorttype},{/if}
                                                                    {if $client->Regstreet}{$client->Regstreet} {$client->Regstreet_shorttype},{/if}
                                                                    д.{$client->Reghousing},
                                                                    {if $client->Regbuilding}стр. {$client->Regbuilding},{/if}
                                                                    {if $client->Regroom}кв.{$client->Regroom}{/if}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Адрес проживания</td>
                                                                <td>
                                                                    {if $client->Faktindex}{$client->Faktindex}, {/if}
                                                                    {$client->Faktregion} {$client->Faktregion_shorttype}
                                                                    ,
                                                                    {if $client->Faktcity}{$client->Faktcity} {$client->Faktcity_shorttype},{/if}
                                                                    {if $client->Faktdistrict}{$client->Faktdistrict} {$client->Faktdistrict_shorttype},{/if}
                                                                    {if $client->Faktlocality}{$client->Faktlocality} {$client->Faktlocality_shorttype},{/if}
                                                                    {if $client->Faktstreet}{$client->Faktstreet} {$client->Faktstreet_shorttype},{/if}
                                                                    д.{$client->Fakthousing},
                                                                    {if $client->Faktbuilding}стр. {$client->Faktbuilding},{/if}
                                                                    {if $client->Faktroom}кв.{$client->Faktroom}{/if}
