    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0"><i class="mdi mdi-file-chart"></i>Выгрузка 1с</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item"><a href="tools">Инструменты</a></li>
                    <li class="breadcrumb-item active">Выгрузка клиентов в 1с</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <form id="data">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Выгрузка клиентов в 1с с {if $date_from}{$date_from|date} - {$date_to|date}{/if}</h4>
                            <div class="row">
                    ...
                    <div class="alert alert-info">
                        <h4>Укажите параметры для выгрузки</h4>
                    </div>
                </div>
            </div>
            <!-- Column -->
